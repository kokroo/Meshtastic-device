 ...
 */
#define MIN_BAT_MILLIVOLTS 3000 // millivolts. 10% per https://blog.ampow.com/lipo-voltage-chart/

#define BAT_MILLIVOLTS_FULL 4200
#define BAT_MILLIVOLTS_EMPTY 3000
